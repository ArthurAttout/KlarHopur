...
public class CameraFragment extends Fragment implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    /**
     * Stores the final picture that will be used to send to the server
     */
    Bitmap finalPicture;
     ...
     */
    public static CameraFragment newInstance(CameraActivity camera) {
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback = new CameraCaptureSession.CaptureCallback() {
        /**
         * Custom function to process Capture Callbacks
         */
    ...
    /**
     * Called immediately after {@link CameraFragment#onCreateView} has returned,
     * but before any saved state has been restored in to the view.
     */
    @Override
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.takePictureBtn).setOnClickListener(this);
    ...
    /**
     * Request permission to use camera at run time.
     */
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults.length != 1 || grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                // if request to user camera has been denied
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface, mImageReader.getSurface()),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(@NonNull CameraCaptureSession cameraCaptureSession) {
                            showToast(getString(R.string.camera_preview_creation_failed));
                        }
                    }, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.takePictureBtn){
            takePicture();
        }
